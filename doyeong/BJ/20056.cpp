...
int main(void) {
  ...
  vector<pair<pair<int, int>, tuple<int, int, int>>> v[50 + 5][50 + 5];
  vector<pair<pair<int, int>, tuple<int, int, int>>> fire_ball;
  ...
  for (int i = 1; i <= K; i++) {
    ...
    vector<pair<pair<int, int>, tuple<int, int, int>>> temp;
